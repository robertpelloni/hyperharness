...
func (r *Registry) registerGeminiCLITools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'write_file' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["path"].(string)
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'list_directory' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["path"].(string)
			if path == "" {
				path = "."
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'shell' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'find_files' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			pattern, _ := args["pattern"].(string)
			if pattern == "" {
				return "", fmt.Errorf("pattern is required")
...
func (r *Registry) registerOpenCodeTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'apply_diff' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			filePath, _ := args["file_path"].(string)
...
func (r *Registry) registerGrokTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'file_read' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["path"].(string)
			piArgs := map[string]interface{}{"path": path}
			raw, _ := json.Marshal(piArgs)
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'file_write' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["path"].(string)
			content, _ := args["content"].(string)
			piArgs := map[string]interface{}{"path": path, "content": content}
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'execute_command' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			command, _ := args["command"].(string)
			piArgs := map[string]interface{}{"command": command}
			raw, _ := json.Marshal(piArgs)
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'scan_directory' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["path"].(string)
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'search_code' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			pattern, _ := args["pattern"].(string)
			piArgs := map[string]interface{}{"pattern": pattern}
			if path, ok := args["path"].(string); ok && path != "" {
