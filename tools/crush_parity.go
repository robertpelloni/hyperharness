...
func (r *Registry) registerWriteTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'write' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["file_path"].(string)
...
func (r *Registry) registerWebFetchTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'web_fetch' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerWebSearchTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'web_search' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerDiagnosticsTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'diagnostics' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			filePath, _ := args["file_path"].(string)
...
func (r *Registry) registerReferencesTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'references' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerJobManagementTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'job_output' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'job_kill' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			jobID, _ := args["job_id"].(string)
			if jobID == "" {
				return "", fmt.Errorf("job_id is required")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'job_list' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerSafeTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'safe' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerDownloadTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'download' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			url, _ := args["url"].(string)
...
func (r *Registry) registerSourcegraphTool() {
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'sourcegraph' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			query, _ := args["query"].(string)
			if query == "" {
				return "", fmt.Errorf("query is required")
