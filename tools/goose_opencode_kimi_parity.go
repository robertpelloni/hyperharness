...
func (r *Registry) registerGooseTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Tool' tool execution, mapping parameters to the underlying foundation functionality.
...
Status: completed.
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'codesearch' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'plan_exit' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'plan_enter' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerKimiCLITools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'TaskStop' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			taskID, _ := args["task_id"].(string)
			if taskID == "" {
				return "", fmt.Errorf("task_id is required")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Think' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'AskUser' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Glob' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'PlanEnter' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'PlanExit' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
...
func (r *Registry) registerCursorTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'cursor_run_command' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'cursor_code_search' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			query, _ := args["query"].(string)
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'cursor_list_dir' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			path, _ := args["relative_path"].(string)
			if path == "" {
				path = "."
...
func (r *Registry) registerWindsurfTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'cascade_command' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			command, _ := args["command"].(string)
			piArgs := map[string]interface{}{"command": command}
...
func (r *Registry) registerMistralVibeTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'mistral_edit' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'mistral_search' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			query, _ := args["query"].(string)
			piArgs := map[string]interface{}{"pattern": query}
			if path, ok := args["path"].(string); ok && path != "" {
...
func (r *Registry) registerSmitheryTools() {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'smithery_install' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'smithery_list' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
