...
import (
	"github.com/robertpelloni/hyperharness/internal/sessions/cron"
	"encoding/json"
	"fmt"
	"strings"
	"time"
...
func registerClaudeCodeTools(r *Registry) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'TodoWrite' tool execution, mapping parameters to the underlying foundation functionality.
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Agent' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'WebSearch' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'WebFetch' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			url := GetStr(args, "url")
			if url == "" {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'AskUserQuestion' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'NotebookEdit' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'LSP' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			operation := GetStr(args, "operation")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Skill' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'ToolSearch' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			query := GetStr(args, "query")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Config' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			operation := GetStr(args, "operation")
			key := GetStr(args, "key")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'EnterPlanMode' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'ExitPlanMode' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'EnterWorktree' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		Parameters:  json.RawMessage(`{"type":"object","properties":{}}`),
		// Execute handles the 'ExitWorktree' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'SendMessage' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'TaskCreate' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'TaskGet' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'TaskList' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'TaskUpdate' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			id := GetStr(args, "taskId")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'Sleep' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'platform__manage_schedule' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
			action := GetStr(args, "action")
			cm := cron.DefaultCronManager
			...
			case "create":
				...
				if err := cm.CreateSchedule(id, schedule, task); err != nil {
					return "", err
				}
				return fmt.Sprintf("Created schedule: '%s' with task '%s' (ID: %s)", schedule, task, id), nil
			case "list":
				jobs := cm.ListSchedules()
				if len(jobs) == 0 {
					return "Active schedules: None", nil
				}
				
				var result string
				for _, j := range jobs {
					result += fmt.Sprintf("- ID: %s | Schedule: %s | Task: %s\n", j.ID, j.Schedule, j.Task)
				}
				return result, nil
			case "delete":
				id := GetStr(args, "id")
	...
	r.Tools = append(r.Tools, Tool{
		...
		// Execute handles the 'PowerShell' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
	...
	r.Tools = append(r.Tools, Tool{
		...
		Parameters:  json.RawMessage(`{"type":"object","properties":{}}`),
		// Execute handles the 'Brief' tool execution, mapping parameters to the underlying foundation functionality.
		Execute: func(args map[string]interface{}) (string, error) {
