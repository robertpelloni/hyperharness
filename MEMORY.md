...
> **Status:** Borg-native memory is live; external parity remains selective.

## What is implemented now

Borg memory currently supports:
...
Borg’s memory model is operator-first:
...
Memory remains part of Borg’s control plane in `packages/core`, surfaced through typed routers and dashboard pages.

Design principles:

- keep one coherent Borg-native model,
