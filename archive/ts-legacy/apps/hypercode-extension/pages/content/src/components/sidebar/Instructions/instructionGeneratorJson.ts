...
export const generateInstructionsJson = (
  ...
  instructions +=
<<<<<<<< HEAD:archive/ts-legacy/apps/hypercode-extension/pages/content/src/components/sidebar/Instructions/instructionGeneratorJson.ts
...
>>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:apps/borg-extension/pages/content/src/components/sidebar/Instructions/instructionGeneratorJson.ts
