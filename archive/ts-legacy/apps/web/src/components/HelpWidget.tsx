...
<<<<<<< HEAD:archive/ts-legacy/apps/web/src/components/HelpWidget.tsx
...
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:apps/web/src/components/HelpWidget.tsx
            </div>
        </div>
    );
};
