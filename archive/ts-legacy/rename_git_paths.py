<<<<<<< HEAD:archive/ts-legacy/rename_git_paths.py
import os
import subprocess
...
def rename_paths():
    ...
    for d in dirs:
        ...
        new_basename = basename.replace('hypercode', 'hypercode').replace('Hypercode', 'HyperCode').replace('HYPERCODE', 'HYPERCODE')
...
if __name__ == '__main__':
    rename_paths()
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:rename_git_paths.py
