...
<<<<<<< HEAD:archive/ts-legacy/packages/vscode/src/extension.ts
let sidebarProvider: HyperCodeSidebarProvider | null = null;
=======
let sidebarProvider: BorgSidebarProvider | null = null;
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:packages/vscode/src/extension.ts
