...
<<<<<<< HEAD:archive/ts-legacy/packages/core/src/services/mcp-server-pool.service.test.ts
...
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:packages/core/src/services/mcp-server-pool.service.test.ts
);
