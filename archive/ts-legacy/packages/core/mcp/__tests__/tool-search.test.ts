...
<<<<<<< HEAD:archive/ts-legacy/packages/core/mcp/__tests__/tool-search.test.ts
    const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'hypercode-mcp-search-'));
=======
    const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'borg-mcp-search-'));
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:packages/core/mcp/__tests__/tool-search.test.ts
    tempDirs.push(dir);
