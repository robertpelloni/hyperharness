...
import os from "os";
<<<<<<< HEAD:archive/ts-legacy/packages/tools/src/MemoryTools.js
const MEMORY_DIR = path.join(os.homedir(), '.hypercode', 'memory');
=======
const MEMORY_DIR = path.join(os.homedir(), '.borg', 'memory');
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:packages/tools/src/MemoryTools.js
