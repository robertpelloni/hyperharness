...
<<<<<<< HEAD:archive/ts-legacy/packages/tools/src/ReaderTools.ts
                console.log(`[HyperCode Reader] Fetching ${url}...`);
=======
                console.log(`[borg Reader] Fetching ${url}...`);
>>>>>>> origin/dependabot/cargo/packages/zed-extension/cargo-64b2a50fd2:packages/tools/src/ReaderTools.ts
