# Context Retriever - Evaluation Tests

## Overview

**Agent:** `subagents/core/context-retriever`  
**Parent Agent:** `openagent`  
**Description:** Generic context search and retrieval for repositories

## Test Structure

```
core/context-retriever/
├── config/
...
```bash
# Using npm
npm run eval:sdk -- --subagent=core-context-retriever

# Using Makefile
make test-subagent SUBAGENT=core-context-retriever

# Verbose output
npm run eval:sdk -- --subagent=core-context-retriever --verbose
```
...
```bash
# Using npm
npm run eval:sdk -- --subagent=core-context-retriever --delegate

# Using Makefile
make test-subagent-delegate SUBAGENT=core-context-retriever
```
...
3. Add appropriate tags: `subagent`, `core-context-retriever`, suite name
...
- [Agent Source](.opencode/agent/subagents/core/context-retriever.md)
