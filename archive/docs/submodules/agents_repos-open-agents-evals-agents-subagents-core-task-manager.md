...
```bash
# Using npm
npm run eval:sdk -- --subagent=core-task-manager

# Using Makefile
make test-subagent SUBAGENT=core-task-manager

# Verbose output
npm run eval:sdk -- --subagent=core-task-manager --verbose
```
...
```bash
# Using npm
npm run eval:sdk -- --subagent=core-task-manager --delegate

# Using Makefile
make test-subagent-delegate SUBAGENT=core-task-manager
```
...
3. Add appropriate tags: `subagent`, `core-task-manager`, suite name
