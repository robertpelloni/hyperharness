...
## Context
The router is Hypercode's sharpest differentiator for v1.0. It must aggregate multiple MCP servers behind one endpoint with clear namespaces and operational visibility.
...
## Requirements
1. Aggregate multiple MCP servers through one Hypercode endpoint.
...
## Acceptance Criteria
- [x] Multiple MCP servers are reachable through one Hypercode endpoint
...
## Out of Scope
- Rebuilding every third-party MCP project inside Hypercode
