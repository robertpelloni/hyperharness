...
## Context
Hypercode currently looks wider than it really is. Several dashboard pages are parity shells, iframe wrappers, or aspirational placeholders. This weakens the 1.0 story and confuses operators.
...
3. Hypercode 1.0 surfaces are immediately obvious to a first-time operator
