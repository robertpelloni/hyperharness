// Package projects provides project registration and discovery.
// Ported from hypercode/go/internal/projects/tracker.go
//
// WHAT: Tracks known projects/workspaces with language detection and activity stats
// WHY: Multi-project orchestration needs to know what projects exist and their types
// HOW: JSON-backed store with auto-detection of Go, TS, Python, Rust, Java, etc.
package projects
