// Package submodules provides git submodule management.
// Ported from hypercode/go/internal/submodules/service.go
//
// WHAT: Tracks, updates, and syncs git submodules
// WHY: Harness uses many submodules as reference implementations for feature parity
// HOW: Git CLI wrapper with status parsing and upstream change detection
package submodules
...
// CommitCount returns the number of commits behind upstream.
