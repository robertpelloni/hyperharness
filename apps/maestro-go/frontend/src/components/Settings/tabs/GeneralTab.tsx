...
import {
	MAESTRO_UPDATES_DISABLED_REASON,
	...
	return (
		<div className="space-y-5">
			...
			<SettingCheckbox
				...
				checked={MAESTRO_UPDATES_ENABLED ? checkForUpdatesOnStartup : false}
				onChange={
					MAESTRO_UPDATES_ENABLED ? setCheckForUpdatesOnStartup : (() => undefined)
				}
				theme={theme}
			/>
			...
			<SettingCheckbox
				...
				description={
					MAESTRO_UPDATES_ENABLED
						? 'Opt-in to receive pre-release versions (e.g., v0.11.1-rc, v0.12.0-beta). These may contain experimental features and bugs.'
						: 'Disabled because automatic updates are turned off for this fork.'
				}
				checked={MAESTRO_UPDATES_ENABLED ? enableBetaUpdates : false}
				onChange={MAESTRO_UPDATES_ENABLED ? setEnableBetaUpdates : (() => undefined)}
				theme={theme}
			/>
