...
export { hasCachedSynopsis } from './synopsisCache';

export function AIOverviewTab({ theme, onSynopsisReady }: AIOverviewTabProps) {
	const cachedSynopsis = getCachedSynopsis();
			...
			<div className="flex-1 overflow-y-auto p-6 scrollbar-thin">
				...
				{synopsis ? (
					<div className="director-notes-content">
						...
						<Suspense fallback={<div className="whitespace-pre-wrap">{synopsis}</div>}>
